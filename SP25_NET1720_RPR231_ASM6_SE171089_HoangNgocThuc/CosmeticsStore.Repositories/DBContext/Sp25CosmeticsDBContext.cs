...
namespace CosmeticsStore.Repositories.DBContext;
...
public partial class Sp25CosmeticsDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Cosmetic__19093A2B88F2C417");
        });

        modelBuilder.Entity<CosmeticInformation>(entity =>
        {
            entity.HasKey(e => e.CosmeticId).HasName("PK__Cosmetic__98ED527E76173D2E");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586FEAEF3AF");
